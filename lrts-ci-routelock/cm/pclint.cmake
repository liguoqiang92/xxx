...
if (LINT)
	set(PC_LINT_EXECUTABLE "d:/pclint/lint-nt.exe" CACHE STRING "full path to the pc-lint executable. NOT the generated lin.bat")
	if (EXISTS ${PC_LINT_EXECUTABLE})
		set(EN_LINT True CACHE STRING "find and enable pc-lint")

		set(PC_LINT_CONFIG_DIR "d:/pclint/" CACHE STRING "full path to the directory containing pc-lint configuration files")
...
function(add_pc_lint target)
	if (WIN32 AND LINT)
		...
		#MESSAGE(STATUS "Get PCLINT FLG: " ${lint_include_directories}, ${lint_defines_transformed}, ${ARGN})
		...
		foreach(sourcefile ${ARGN})
			...
			if( sourcefile MATCHES \\.c$|\\.cxx$|\\.cpp$ )
				...
				list(APPEND pc_lint_commands
					COMMAND ${PC_LINT_EXECUTABLE} "-d_WINDOWS"
		...
		#MESSAGE(STATUS "Get PCLINT CMD: " ${pc_lint_commands})
